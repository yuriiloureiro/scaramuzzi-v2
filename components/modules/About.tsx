    ...
    <section className="py-24 px-8 bg-background">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="aspect-square max-h-[550px] overflow-hidden border-[12px] border-white shadow-2xl rounded-sm">
            <img
              src="/images/about/about.jpeg"
              alt="Scaramuzzi Imóveis"
              className="w-full h-full object-cover object-top" // object-top para focar no rosto
            />
          </div>
        ...
        >
          ...
          <p className="text-secondary/70 leading-relaxed mb-6">
            ...
            que transcendem o morar. Especializados no mercado de alto padrão no
            Rio de Janeiro, nossa missão é oferecer uma consultoria exclusiva e
            personalizada.
          </p>
